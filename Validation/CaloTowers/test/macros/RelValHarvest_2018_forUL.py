        ...
        if label in line:
            ...
            for str in dsFlags.keys():
                if str in line:
                    ...
                    if (path.find("Ideal") > 0 or path.find("design") > 0  or path.find("upgrade2018") > 0 or path.find("FastSim") > 0 or path.find("HEfail") > 0 or path.find("DQM") < 0 or path.find("Pixel") > 0 ):  #skip for unnecessary samples
                        continue
...
dsDATAFlags = {'283877__JetHT__':'JetHT','283877__ZeroBias__':'ZeroBias', #2016H
               '274199__JetHT__':'JetHT','274199__ZeroBias__':'ZeroBias', #2016B
               '301998__JetHT__':'JetHT','301998__ZeroBias__':'ZeroBias', #2017C
               '302663__JetHT__':'JetHT','302663__ZeroBias__':'ZeroBias', #2017D
               '304125__JetHT__':'JetHT','304125__ZeroBias__':'ZeroBias', #2017E
               '305064__JetHT__':'JetHT','305064__ZeroBias__':'ZeroBias'} #2017F
